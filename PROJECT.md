...
This is the canonical project entry point for the `manifest-skill-cluster`
...
- Repository: `manifest-skill-cluster`
- Registry WorkObject: `program:skill-clusters` (`Skill Clusters`, kind: program)
- GitHub: `Sheshiyer/manifest-skill-137` (identity_status: pending-teamforge-verification)
- Knowledge authority: `CLAUDE.md`
